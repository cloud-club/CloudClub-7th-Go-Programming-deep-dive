...
type ChatMessage struct {
	...
	User          string                 `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`                         // 보내는 사람
	TargetId      string                 `protobuf:"bytes,2,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"` // 받는 사람 👈 이 줄 추가!
	Message       string                 `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`                   // 메시지 본문
...
func (x *ChatMessage) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
const file_proto_chat_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x04 \x01(\x03R\ttimestamp2E\n" +
	"\vChatService\x126\n" +
	"\n" +
	"ChatStream\x12\x11.chat.ChatMessage\x1a\x11.chat.ChatMessage(\x010\x01B\x12Z\x10grpc-chat/gen;pbb\x06proto3"
